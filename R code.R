...
var_url <- c("E000N00/E000N00", "E000N20/E000N20", "E020N20/E020N20","E020N00/E020N00")
...
map3 <- magick::image_annotate(
  map2, "Democratic Republic of Congo",
  font = "Georgia",
  color = title_color,
...
map4 <- magick::image_annotate(
  map3, "©2024 Femi Olamijulo (https://github.com/femiolamijulo)",
  font = "Georgia",
